...
<div id="post-<?php the_ID(); ?>" <?php post_class('entry clearfix ' . $post_class); ?>>
   ...
   <!-- /Post Title -->
    ...
    <div class="entry-image entry-image-left">
        ...
        <?php } else { ?>
        <a class="post-thumbnail post-thumbnail-small" href="<?php the_permalink(); ?>"><img src="<?php echo get_template_directory_uri() ?>/assets/img/post_def_image.png" class="img-responsive" /></a><?php } ?>
    </div>
    ...
    <?php } else if($vega_wp_enable_demo == 'Y') { ?>
        <a class="post-thumbnail post-thumbnail-large" href="<?php the_permalink(); ?>"><img src="<?php echo get_template_directory() ?>/assets/img/post_def_image.png" class="img-responsive" /></a><?php } ?>
